...
![](Pasted%20image%2020250106094804.png)
#### 6.2 最小二乘法:
...
7. 【分光计左右窗读数的原理】：仪器偏心差
![](Pasted%20image%2020250106112705.png)
## III. 示波器

1.  李萨如：$f_y : f_x = N_x : N_y$
2.  一些调节方法：
![](Pasted%20image%2020250106113909.png)
...
7. 二极管正向导通电压测量：  
电路图：
![](Pasted%20image%2020250106130549.png)
计算公式：$(\frac{U_{1p-p}}{2}-U_{2p})$是导通电压
8. 相位差测量：
![](Pasted%20image%2020250106130807.png)
